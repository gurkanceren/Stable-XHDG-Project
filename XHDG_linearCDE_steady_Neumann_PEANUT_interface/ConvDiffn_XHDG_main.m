...
for p=1 %degree
    ...
    for m=5  %mesh number
        ...
        X = 2*X - 1.00; % modify the mesh to have it defined in [-1,1]
        ...
        example = 3; % flower/peanut interface
        ...
        [K f QQ UU Qf Uf] = hdg_matrix(X,T,F,referenceElement,infoFaces,tau,LS,Elements,mu,upwind);
        ...
        [u_star,shapeFunctions] = hdg_postprocess(X,T,u,q,referenceElement_star,referenceElement,Elements,LS);
        disp('Done!')
