function [u_star,shapeFunctions] = hdg_postprocess(X,T,u,q,referenceElement_star,referenceElement,Elements,LS)
global example 
...
for iElem = 1:nOfElements
    ...
    [Ke,Beqe,int_ue_star, int_ue] = ElementalMatrices(Xe,referenceElement_star,ue,qe,Elements,iElem,LSe_star,referenceElement);
...
function [K,Bq,int_u_star,int_u] = ElementalMatrices(Xe,referenceElement_star,ue,qe,Elements,iElem,LSe_star,referenceElement)
