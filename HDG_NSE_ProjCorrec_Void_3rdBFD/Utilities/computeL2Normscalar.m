function L2Norm = computeL2Normscalar(referenceElement,X,T,u,u0,time,Re,varargin)
...
for iElem = 1:nOfElements 
    ...
    Xe = X(Te,:);
    ue = u(Te);
    L2Norm = L2Norm + ElementalL2Norm(Xe,referenceElement,ue,u0,time,Re,varargin{:}); 
end
L2Norm = sqrt(L2Norm);


%_______________________________________________________________________
function elemL2Norm = ElementalL2Norm(Xe,referenceElement,ue,u0,time,Re,varargin)
...
for g = 1:ngauss
    ...
    xy_g = N_g*Xe;
    ue_g = N_g*ue;
    u0_g = analyticalpressure(xy_g,time,Re);
    %Jacobian
    J = [Nxi_g*xe	  Nxi_g*ye   
         Neta_g*xe  Neta_g*ye];
    %Integration weight
