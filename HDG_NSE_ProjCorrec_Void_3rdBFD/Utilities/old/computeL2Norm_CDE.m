function L2Norm = computeL2Norm(referenceElement,X,T,u,u0,time,varargin)
...
for iElem = 1:nOfElements 
    ...
    Xe = X(Te,:);
    ue = u(Te);
    L2Norm = L2Norm + ElementalL2Norm(Xe,referenceElement,ue,u0,time,varargin{:}); 
end
L2Norm = sqrt(L2Norm);


%_______________________________________________________________________
function elemL2Norm = ElementalL2Norm(Xe,referenceElement,ue,u0,time,varargin)
