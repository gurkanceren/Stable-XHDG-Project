...
function [KKnew fnew uDirichlet CD unknowns]=SystemReduction(KKold,fold,T,X,infoFaces,referenceElement,F)
...
figure(1), hold on, h2=plot(XDirichlet(:,1),XDirichlet(:,2),'r*');
...
% % nDOF = nOfInteriorFaces*nOfFaceNodes;                     %%%%% Dirichlet %%%%%%%
