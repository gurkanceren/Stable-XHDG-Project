function [u_star,shapeFunctions] = hdg_postprocess(X,T,u,q,referenceElement_star,referenceElement,mu_vector)
...
for iElem = 1:nOfElements
    ...
    mu=mu_vector(iElem);
    [Ke,Beqe,int_ue_star, int_ue] = ElementalMatrices(Xe,referenceElement_star,ue,qe,mu);
...
function [K,Bq,int_u_star,int_u] = ElementalMatrices(Xe,referenceElement_star,ue,qe,mu)
