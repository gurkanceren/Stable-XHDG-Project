...
function [Auq,Alu,Alq,Auu,Aqq,All,fe]=xhdg_matrix_d1(referenceElement,mu1,PtsInt,FaceInfo,tau,Xe,LSe,iElem)
...
for iface = 1:nOfFaces
    ...
    q_analy=-mu1*ones((2*size(u_analy,1)),1);
    q_analy(2:2:end)=0;
