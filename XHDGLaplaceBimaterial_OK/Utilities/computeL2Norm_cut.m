function L2Norm = computeL2Norm_cut(LSe,referenceElement,X,T,u,u0,varargin)
...
for iElem = 1:nOfElements
    L2Norm = L2Norm + ElementalL2Norm(X,u,u0,N,Nxi,Neta,Nold,Nxi_old,Neta_old,weight,ngauss,varargin{:});
end
L2Norm = sqrt(L2Norm);


%_______________________________________________________________________
function elemL2Norm = ElementalL2Norm(Xe,u,u0,N,Nxi,Neta,Nold,Nxi_old,Neta_old,weight,ngauss,varargin)
