function interfaceBasisAndQuadrature=computeBasisAndQuadratureAlongInterface(X,T,LS,referenceElement,Elements)
...
interfaceBasisAndQuadrature=struct('nodesXY',interfaceNodesPhysical,...
