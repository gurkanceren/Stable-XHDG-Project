function plotMesh(X,T,Elements,~,~)
%function varargout = plotMesh(X,T,Elements,option,nodesNum)
...
patchHandle = patch('Faces',patchFaces1,'Vertices',X,'FaceColor',[0.9  0.9  0.9],'EdgeAlpha',1);
axis equal
hold on
patchHandle2 = patch('Faces',patchFaces2,'Vertices',X,'FaceColor',[0.2 0.2 0.2],'EdgeAlpha',1);
hold on
patchHandle3 = patch('Faces',patchFaces3,'Vertices',X,'FaceColor',[0.6   0.6    0.6],'EdgeAlpha',1);
% %Optional plots
% if nargin > 2
%     hold on
