function [u_star,shapeFunctions] = hdg_postprocess_test(X,T,u,q,referenceElement_star,referenceElement,Elements,mu1,mu2)
...
%         qe(2*npoints+2:2:4*npoints,1)   =  shapeFunctions*q(y_ind(nOfElementNodes+1:end));
    ...
    if isempty(c) && isempty(d);
        ...
        sol=sol(1:end-1);
        index = (ielem-1)*(4*nOfElementNodes) + (1:4*nOfElementNodes);
