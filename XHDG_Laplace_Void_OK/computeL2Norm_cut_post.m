...
function L2Norm = computeL2Norm_cut_post(LSe,referenceElement_star,X,T,u,u0,varargin)
...
p = referenceElement_star.degree;
...
for iElem = 1:nOfElements
    ...
    Xe = X(Te,:);
    ue = u(Te);
    L2Norm = L2Norm + ElementalL2Norm(Xe,ue,u0,N,Nxi,Neta,weight,ngauss,varargin{:});
end
L2Norm = sqrt(L2Norm);


%_______________________________________________________________________
function elemL2Norm = ElementalL2Norm(Xe,ue,u0,N,Nxi,Neta,weight,ngauss,varargin)
