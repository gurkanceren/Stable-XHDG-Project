function [KKnew fnew uDirichlet CD unknowns nullFaces zeroRows]=SystemReductionPCorr(KKold,fold,T,X,infoFaces,referenceElement,time,Re)
...
%uDirichlet=computeProjectionFacesDirchletPressCorr(@DirichletCondition,infoFaces.extFaces,X,T,referenceElement);
uDirichlet=computeProjectionFacesDirchletPressCorr(infoFaces.extFaces,X,T,referenceElement,time,Re);
