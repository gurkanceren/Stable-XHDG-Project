function u=computeProjectionFacesDirchletPredictorStep(Faces,X,T,referenceElement,time,Re)
...
nOfComponents = 2; %length(feval(dataFunction,[1,1]));
...
for f=1:nOfFaces
    ...
    ug = analyticalVelocityStokes([xfg,yfg],time,Re);
