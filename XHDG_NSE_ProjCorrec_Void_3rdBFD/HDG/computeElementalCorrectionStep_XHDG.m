function [u_crc,p_crc,p_wrc_crc]=computeElementalCorrectionStep_XHDG(LS,Elements,u,uhat,pcorr,phat,qcorr,X,T,F,referenceElement,infoFaces,tauP,dt,Re,a_parm,time,cnt,pold)
...
for iElem =1:nOfElements
    ...
    [u_lcl,p_lcl,p_wrc]=ElementalVariables(LSe,Elements,Fe,Xe,referenceElement,nOfInteriorFaces,infoFaces,tauP,dt,Re,a_parm,uE,pcorrE,qcorrE,uhatE,phatE,time,cnt,poldE,iElem);
    %
...
function [u_lcl,p_lcl,p_wrc] = ElementalVariables(LSe,Elements,Fe,Xe,referenceElement,nOfInteriorFaces,infoFaces,tau,dt,Re,a_parm,uE,pcorrE,qcorrE,uhatE,phatE,time,cnt,poldE,iElem)
...
for iface = 1:nOfFaces
    ...
    for g = 1:glim
        ...
        %
        Qcorr_gaussFaceX = Nf_g2*qx(nodes,:);
        Qcorr_gaussFaceY = Nf_g2*qy(nodes,:);
        %
...
if(limiter==1)
    %
    p_cg = analyticalpressure(Xe,time);
