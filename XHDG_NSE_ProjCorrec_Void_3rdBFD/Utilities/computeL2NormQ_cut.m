function L2Norm = computeL2NormQ_cut(LSe,referenceElement,X,T,q,q0,varargin)
...
for iElem = 1:nOfElements
    ...
    Xe = X(Te,:);
    qe = q;
    L2Norm = L2Norm + ElementalL2Norm(Xe,qe,q0,N,Nxi,Neta,weight,ngauss,varargin{:});
end
L2Norm = sqrt(L2Norm);


%_______________________________________________________________________
function elemL2Norm = ElementalL2Norm(Xe,qe,q0,N,Nxi,Neta,weight,ngauss,varargin)
