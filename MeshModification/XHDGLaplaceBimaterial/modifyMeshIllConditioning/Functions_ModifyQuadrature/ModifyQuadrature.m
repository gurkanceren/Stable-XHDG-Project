function [zgp,wgp,n1,n2,PtsInt_e] = ModifyQuadrature(LSe,referenceElement,zgp_tri,wgp_tri,zgp_qua,wgp_qua)
%
...
if CheckStdElement(LSe,referenceElement)
    [zgp,wgp,vect_mu,PtsInt_e] = ModifyQuadratureStdTri(referenceElement.NodesCoord,LSe,referenceElement,zgp_tri,wgp_tri,zgp_qua,wgp_qua);
else
    ...
    while ~isempty(List_NoStdTri)
        ...
        if CheckStdElement(LSe_aux,referenceElement)
            [zgp1,wgp1,vect_mu1,PtsInt_e1] = ModifyQuadratureStdTri(Xe_aux,LSe_aux,referenceElement,zgp_tri,wgp_tri,zgp_qua,wgp_qua);
            zgp = [zgp; zgp1];
            wgp = [wgp, wgp1];
