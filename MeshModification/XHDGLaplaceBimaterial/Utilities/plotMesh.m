...
axis equal
hold on
patchHandle2 = patch('Faces',patchFaces2,'Vertices',X,'FaceColor',[1 0.6 0],'EdgeAlpha',1);
hold on
patchHandle3 = patch('Faces',patchFaces3,'Vertices',X,'FaceColor',[0    1    0],'EdgeAlpha',1);
