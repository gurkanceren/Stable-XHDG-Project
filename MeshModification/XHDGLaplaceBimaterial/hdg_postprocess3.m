...
function [u_star,shapeFunctions] = hdg_postprocess3(X,T,u,q,referenceElement_star,referenceElement,Elements,mu1,mu2)
...
for ielem = 1:nOfElements
    ...
    [Ke,Beqe,int_ue_star,int_ue] = ElementalMatrices(Xg,referenceElement_star,ue,qe,Elements,ielem,LSe_star,mu1,mu2);
         
    int_ue_star1=zeros(nOfElementNodes_star*2,1);
    int_ue_star1(1)=1;
    int_ue1=ue(1);
    
    int_ue_star2=zeros(((nOfElementNodes_star*2)+1),1);
    int_ue_star2(nOfElementNodes_star+1)=1;
    int_ue2=ue(nOfElementNodes_star+1);
        
    K1 = [Ke int_ue_star; int_ue_star' 0];
    f1 = [Beqe;int_ue];
    
    K2= [K1 int_ue_star2 ; int_ue_star2' 0 ];
    f2= [f1;int_ue2];
...
function [K,Bq,int_u_star,int_u] = ElementalMatrices(Xe,referenceElement_star,ue,qe,Elements,iElem,LSe_star,mu1,mu2)
...
for g = 1:ngauss
    ...
    Bq = Bq - (Nx_g'*qx_g + Ny_g'*qy_g)*dvolu*1/mu(g);
