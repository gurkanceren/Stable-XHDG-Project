...
for iElem = 1:nOfElements 
    Te = T(iElem,:); 
    Xe = X(Te,:);
    ue = u(nOfElementNodes*(iElem-1)+[1:nOfElementNodes]);  %not necessary
    L2Norm = L2Norm + ElementalL2Norm(Xe,N,Nxi,Neta,weight,ngauss,ue,u0,varargin{:}); 
end
%L2Norm = sqrt(L2Norm);


%_______________________________________________________________________
function elemL2Norm = ElementalL2Norm(Xe,N,Nxi,Neta,weight,ngauss,ue,u0,varargin)
