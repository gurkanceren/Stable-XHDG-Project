...
for iElem = 1:nOfElements
    ...
    % elemental matrices
    [Qe,Ue,Qfe,Ufe,Alq,Alp,All] = KKeElementalMatrices(LSe,Elements,Fe,Xe,referenceElement,nOfInteriorFaces,infoFaces,u_Elem,uhat_Elem,tauP,dt,a_parm,iElem,time);
...
% ELEMENTAL MATRIX
function [Q,U,Qf,Uf,Alq,Alp,All] = KKeElementalMatrices(LSe,Elements,Fe,Xe,referenceElement,nOfInteriorFaces,infoFaces,u_Elem,uhat_Elem,tau,dt,a_parm,iElem,time)
