function L2Norm = computeL2Norm_cutpress(LSe,referenceElement,X,T,u,u0,time,Re,varargin)
...
for iElem = 1:nOfElements
    L2Norm = L2Norm + ElementalL2Normpress(X,u,u0,N,Nxi,Neta,weight,ngauss,time,Re,varargin{:});
end
L2Norm = sqrt(L2Norm);


%_______________________________________________________________________
function elemL2Norm = ElementalL2Normpress(Xe,u,u0,N,Nxi,Neta,weight,ngauss,time,Re,varargin)
