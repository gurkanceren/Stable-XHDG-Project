function [KKnew fnew uDirichlet CD unknowns nullFaces zeroRows]=SystemReductionPCorr(KKold,fold,T,X,infoFaces,referenceElement,time)
...
uDirichlet=computeProjectionFacesDirchletPressCorr(infoFaces.extFaces,X,T,referenceElement,time);
