function PlotSol(fignum,u,X,T,LS,referenceElement,Elements)
...
%     
%     
%     shapeFunctions4 = computeShapeFunctionsAtPoints(1,referenceElement.NodesCoord(1:3,:),zpg);
